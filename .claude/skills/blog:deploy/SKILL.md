...
model: haiku
allowed-tools:
  - Bash(bash /Users/changhwan/workspace/tech_blog/.claude/skills/blog:deploy/scripts/deploy.sh)
  - Read
---
# blog:deploy
...
- 작업 디렉토리: `/Users/changhwan/workspace/tech_blog`
- 배포 명령: `gatsby build && gh-pages -d public -b deploy`
- 대상: GitHub Pages `deploy` 브랜치 → `dev.k10n.me`

### Step 2 — 배포 실행

```bash
bash /Users/changhwan/workspace/tech_blog/.claude/skills/blog:deploy/scripts/deploy.sh
```
...
- 배포는 `main` 브랜치 기준이 아닌 **현재 로컬 파일 기준**으로 빌드됨

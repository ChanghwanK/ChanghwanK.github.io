---
slug: 안정적으로 Pod을 운영하기 위한 규칙들
title: Pod을 활용해 애플리케이션을 안정적으로 운영하기 위한 규칙들
authors: [changhwan]
tags: [kubernetes]
comments: true # for Giscus
---

**비즈니스를 운영하는 엔지니어 입장에서 가장 위험 한 것은 서비스 장애로 인한 사용자 경험을 저해시켜 서비스의 신뢰도를 떨어트리는 것이라 생각합니다.** 그렇다고 해서 장애가 0%인 서비스가 있는 것은 아닙니다. 하지만 "장애가 없는 서비스는 없어!" 하고 방치하는 것은 무책임한 것 처사라 생각합니다.
